...
//
    ...
    public struct CurrencyField: View {
        ...
        public init(value: Binding<Int>) {
            ...
            if !formatter.locale.identifier.contains("VN") {
    ...
    private final class NoCaretTextField: UITextField {
    ...
    private struct CurrencyInputField: UIViewRepresentable {
        ...
        func updateUIView(_: NoCaretTextField, context _: Context) {}
        ...
        class Coordinator: NSObject, UITextFieldDelegate {
            ...
            @objc func editingChanged(textField: NoCaretTextField) {
                ...
                guard let char, let digit = Int(String(char)) else {
